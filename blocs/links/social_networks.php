	...
	print <<<BLOC
			...
			<div class='bloc'>
				...
				<div class='bloc_content'>
					...
					<a href='http://github.com/uberchicgeekchick/'><img src='./graphics/icons/art/github.png' alt='githubt&#039;s logo: linking to the git repos for my open source projects.' title='My open source projects &mdash; hosted on github.' class='favicon_link'/></a>
					<a href='http://mugshot.org/person?who=bTJKAMsm3hh43M'><img src='./graphics/icons/web2.0/mugshot.png' alt='MugShot.Org&#039;s logo: linking to my profile on the original social network.' title='My MugShot.Org profile.&nbsp; BTW, MugShot.Org is *the* original social network' class='favicon_link'></a>
					<br/>
					...
					<a href='http://twitter.com/uberChick'><img src='./graphics/icons/web2.0/twitter.png' alt='Twitter&#039;s logo: letting you follow my programming &amp; over-sharing tweets.' title='Follow my programming &amp; over-sharing tweets.' class='favicon_link'/></a>
					<br/>
					...
					<a href='http://pipes.yahoo.com/uberchicgeekchick'><img src='./graphics/icons/art/yahoopipes.png' alt='Pipes.Yahoo.Com&#039;s logo: linking to my customized RSS &amp; Atom feeds.' title='My RSS &amp; Atom feed hacks on Pipes.Yahoo.Com.' class='favicon_link'/></a>
					<br/>
					...
					<a href='http://www.jamendo.com/en/user/uberChicGeekChick'><img src='./graphics/icons/media/jamendo.png' alt='Jamendo.Com&#039;s logo: linking to my creative commons music fangirl profile.' title='My fave artists, albums, &amp;songs at Jamendo.Com which is another creative commons music community.' class='favicon_link'/></a>
					<br/>
					...
					<a href='http://www.facebook.com/profile.php?id=716379174'><img src='./graphics/icons/web2.0/facebook.png' alt='Facebook.Com&#039;s logo: linking to my profile on this social network.' title='My profile on Facebook.Com&#039; social network.' class='favicon_link'/></a>
					<br/>
					others to come...
				</div>
