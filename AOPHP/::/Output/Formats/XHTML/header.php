...
<html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en' lang='en'>
	<head>
		...
		<!-- <style type='text/css'> @import url('./AOPHP/::/Output/Formats/{$this->format}/alacast.css'); </style> -->
		<link rel='stylesheet' href='./AOPHP/::/Output/Formats/{$this->format}/alacast.css' type='text/css'/>
	</head>
	<body>
HEADER;
?>