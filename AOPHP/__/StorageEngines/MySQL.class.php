<?php
	 ...
	 * ------------------------------------------------------------------------
	 */
	namespace AOPHP__StorageEngines;
	
	class MySQL extends AOPHP__StorageEngines{
		private $Connection;
		
		public function __constuct(array $settings){
			return require_once( (__load_method( "AOPHP__StorageEngines__MySQL", "__construct" )) );
		}
	}//end:  class MySQL extends AOPHP__StorageEngine
?>
