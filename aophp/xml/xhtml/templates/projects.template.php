<?php
	...
	print <<<BLOC
				<h1>{$this->content}</h1>
				<h2>{$this->content} @ <a href='http://www.github.com/{$github_profile}/{$project_dir}'>github</h2>
						<div class="github_projects_container">
						<div class="github_projects_download">
							<a href="http://www.github.com/{$github_profile}/{$project_dir}/tarball/master"><img border="0" width="90" src="http://github.com/images/modules/download/tar.png"></a>
							<a href="http://www.github.com/{$github_profile}/{$project_dir}/zipball/master"><img border="0" width="90" src="http://github.com/images/modules/download/zip.png"></a>
						</div>
						
				<h3><a href="http://www.github.com/{$github_profile}/{$project_dir}">{$this->content}</a></h3>
				<span class="small">by <a href="http://www.github.com/{$github_profile}/{$project_dir}">Me :-), &amj; I&#039;m Kaity G. B. / uberChick / uberchicgeekchick</a></small>
				
				<hr/>
				<a href='#project_description'>Description</a><br/>
				<a href='#project_download'>Download</a><br/>
				<a href='#project_installation'>Installation</a><br/>
				<a href='#project_dependencies'>Dependencies</a><br/>
				<a href='#project_license'>License</a><br/>
				<a href='#project_authors'>Authors</a><br/>
				<hr/>
				<a href='project_description'>Description</a>
				<div class="github_projects_description">
				...
				<ul>
					...
					<li><a href="http://www.github.com/{$github_profile}/{$project_dir}/zipball/master" alt="Download {$projects}'s curent source code tarball." title="Download {$projects}'s curent source code tarball.">curent source code tarball</a></li>
					<li><a href="http://www.github.com/{$github_profile}/{$project_dir}/zipball/master" alt="Download {$projects}'s curent source code tarball." title="Download {$projects}'s curent source code tarball.">curent source code in a zipped archive</a></li>
				</ul>
				...
				<hr/>
				<a nama='project_installation'>Installation</a>
				<p>
...
User must be fully accessible, exportable, and deletable to that User.</pre>
				...
				<p>Kaity G. B., aka uberChick, (uberchick@uberchicgeekchick.com)</p>
				<hr/>
				<a name='contact'>Contact</a>
				<p>Kaity G. B. (uberChick@uberChicGeekChick.Com)</p>
			</div>
BLOC;
?>
