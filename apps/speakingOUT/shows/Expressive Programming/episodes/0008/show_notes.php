<?php
	...
	$episode="0008";
	$title="Community, change, compassion, &amp; open source - (much_more++)";
	$iarchive_uri=preg_replace("/[\ ,]/", "", $title);
	$links=array(
		'2009-03-01 - C1X draft spec begins!'=>'http://www.open-std.org/jtc1/sc22/wg14/www/projects#DRs',
		'PHP 5.3RC1 Announcement'=>'http://www.php.net/index.php#id2009-03-24-1',
		''=>'http://www.cbc.ca/dnto/MT/2009/03/mar_2009_liar_liar.html',
		'Mark Shuttleworth - Free Software and Wealth Creation'=>'http://feeds.conversationsnetwork.org/~r/channel/itconversations/~3/BiIUEG4F9M8/detail3994.html',
	);
	"		Please rate &amp; review this episode on [<a href='http://www.archive.org/details/ExpressiveProgramming-{$episode}-ByUberchick'>Internet Archive</a>]<br/>
			<div class='expressive_ogg_player'>
