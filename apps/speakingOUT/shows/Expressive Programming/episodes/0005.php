<?php
		print <<<BLOC
			...
			<p>
				...
				A time when you have to stop planning and start programming.
			</p><p>
				Stop perfecting and start moving on.
			</p><p>
				Some times its a stick figure, some times its the piece flows complete.
			</p><p>
				But our plans & goals only become projects & parts of our life once we draw our first line.
			</p><p>
